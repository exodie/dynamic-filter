...
import { formatRangeData } from '@/tools';
...
export const Range: FC<Props> = ({
  ...
  const [from, setFrom] = useState(minParams ? Number(minParams) : minRange);
  const [to, setTo] = useState(maxParams ? Number(maxParams) : maxRange);
